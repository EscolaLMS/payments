...
{
    public function search(PaymentsSearchAdminRequest $request): PaymentListResponse
    {
        ...
        return new PaymentListResponse(Payments::searchPayments($paymentFilterDto, $orderDto, $paginationDto));
    }
